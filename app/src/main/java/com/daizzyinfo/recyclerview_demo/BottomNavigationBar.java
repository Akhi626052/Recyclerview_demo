...
import com.daizzyinfo.recyclerview_demo.databinding.ActivityBottomNavigationBarBinding;
...
public class BottomNavigationBar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_dashboard, R.id.navigation_notifications, R.id.navigation_order)
                .build();
